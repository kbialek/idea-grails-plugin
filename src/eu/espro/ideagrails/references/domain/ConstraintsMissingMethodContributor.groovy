...
@CompileStatic
class ConstraintsMissingMethodContributor extends ClosureMissingMethodContributor {
    ...
    boolean processMembers(GrClosableBlock closure, PsiScopeProcessor processor, GrReferenceExpression expression, ResolveState resolveState) {
        ...
        if ("constraints" == f.name && f.hasModifierProperty("static")) {
            ...
            if (cf) {
                ...
                m.addParameter("constraints", "java.util.Map")
